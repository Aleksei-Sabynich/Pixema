         ...
         <main className='main main__container'>
            ...
            <nav className='nav'>
               <ul className='list'>
                  ...
                  <NavLink to ='/settings' className={({ isActive }) => isActive ? "list__item-wrapper active" : `list__item-wrapper`}> 
                     <div className='list__item-icon'>
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <p className='list__item-text'>Settings</p>
                  </NavLink>
               </ul>
            </nav>
